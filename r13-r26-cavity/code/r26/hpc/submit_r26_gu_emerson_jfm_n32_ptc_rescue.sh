#!/bin/bash
# Submit the bounded raw-guarded physical PTC rescue of failed N32.
...
R26_GE_JFM_N32_PTC_OUT="${R26_GE_JFM_N32_PTC_OUT:-/project/pi_roohie_umass_edu/CavityColdToHotIdentify/R26_GU_EMERSON_JFM_N32_RAW_GUARDED_PTC_$(date +%Y%m%d_%H%M%S)}"
