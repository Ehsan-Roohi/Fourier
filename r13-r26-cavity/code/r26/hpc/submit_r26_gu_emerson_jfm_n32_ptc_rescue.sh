#!/bin/bash
# Submit the one bounded physical-chain-rule PTC rescue of failed N32.
...
R26_GE_JFM_N32_PTC_OUT="${R26_GE_JFM_N32_PTC_OUT:-/project/pi_roohie_umass_edu/CavityColdToHotIdentify/R26_GU_EMERSON_JFM_N32_PTC_RESCUE_$(date +%Y%m%d_%H%M%S)}"
