...
class MaxwellContract(unittest.TestCase):
    ...
    def test_thor_n28_is_root_locked_conditional_and_fail_closed(self) -> None:
        ...
        self.assertIn("json_native", auditor)
        ...
        self.assertIn("json_native", validator)
        ...
        self.assertIn("verify_root", submit)
        self.assertLess(submit.index("verify_root \"$R26_LEGACY_N27_DIR"), submit.index("sbatch"))
        self.assertIn("b64fcadcf8e7c0e17e1f07df348f5cf619f152662ff606024e11404c79010905", submit)
